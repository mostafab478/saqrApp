...
import 'package:saqr2/AddServiceScreens/%D8%AE%D8%AF%D9%85%D8%A7%D8%AA%20%D8%A7%D9%84%D9%85%D9%86%D8%A7%D8%B2%D9%84.dart';
                            ...
                            Row(mainAxisAlignment: MainAxisAlignment.start,
                              children: [
                                Padding(
                                  padding: const EdgeInsets.only(right:2.0),
                                  child: Text("00"
                                      "966548252999",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.grey),),
                                ),
                ...
                children: [
                  Container(
                    ...
                    FloatingActionButton(child: Icon(Icons.add_circle),
                      onPressed: (){
                        Navigator.push(context,MaterialPageRoute(builder: (context)=>HomeServiceAdd()));
// AddContainer();
