...
class CleaningContainersAdd extends StatefulWidget {
  @override
  _CleaningContainersAddState createState() => _CleaningContainersAddState();
}

class _CleaningContainersAddState extends State<CleaningContainersAdd> {
  @override
