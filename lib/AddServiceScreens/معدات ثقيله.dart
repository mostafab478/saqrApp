...
class HeavyEquipmentAdd extends StatefulWidget {
  @override
  _HeavyEquipmentAddState createState() => _HeavyEquipmentAddState();
}

class _HeavyEquipmentAddState extends State<HeavyEquipmentAdd> {
  @override
